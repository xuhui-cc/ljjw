...
function jwViewStudentProfile(params) {
  return fetch.ljjwfetch(URI, 'jwViewStudentProfile', params)
}

//老师查看学生档案——成绩
function jwViewStudentScores(params) {
  return fetch.ljjwfetch(URI, 'jwViewStudentScores', params)
}

//老师查看学生档案——概况
function jwViewStudentSumary(params) {
  return fetch.ljjwfetch(URI, 'jwViewStudentSumary', params)
}

//老师查看学生档案——学情
function jwViewStudentStudyInfo(params) {
  return fetch.ljjwfetch(URI, 'jwViewStudentStudyInfo', params)
}
...
function jwTeacherTasksMainPage(params) {
  return fetch.ljjwfetch(URI, 'jwTeacherTasksMainPage', params)
}

//老师——每日晨读列表页
function jwTeacherMorningReadMore(params) {
  return fetch.ljjwfetch(URI, 'jwTeacherMorningReadMore', params)
}

//老师——新建每日晨读
function jwTeacherAddMorningRead(params) {
  return fetch.ljjwfetch(URI, 'jwTeacherAddMorningRead', params)
}

//老师——任务列表
function jwTeacherTasks(params) {
  return fetch.ljjwfetch(URI, 'jwTeacherTasks', params)
}

//老师——查看某节课考勤
function jwViewScheduleCheckOn(params) {
  return fetch.ljjwfetch(URI, 'jwViewScheduleCheckOn', params)
}
