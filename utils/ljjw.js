...
function jwTeacherAddMessages(params) {
  return fetch.ljjwfetch(URI, 'jwTeacherAddMessages', params)
}

//学生——提交任务
function jwStudentSaveTask(params) {
  return fetch.ljjwfetch(URI, 'jwStudentSaveTask', params)
}

//学生——毕业院校
function jwGetSchoolList(params) {
  return fetch.ljjwfetch(URI, 'jwGetSchoolList', params)
}

//教务/管理员——请假待审核红点
function jwGetAskforleaveCount(params) {
  return fetch.ljjwfetch(URI, 'jwGetAskforleaveCount', params)
}
